# ds-kedro-dbr-poc
Sample Kedro project for Databricks and MLflow POC
To run on DBR execute command: "kedro run --env dbfs"

## Overview

This is your new Kedro project with some initial Spark configuration and an example pipeline, generated using `Kedro 0.17.6`.
